...
using Streamit_movie_mvc.Services.Interfaces;
    ...
    public class PersonService : IPersonService
    {
        ...
        public async Task<ResponseDTO> ValidateData(NewPerson newPerson)
        {
            ...
            if (newPerson.Thumbnail != null)
            {
                ...
                await _storageService.UploadFile(newPerson.Thumbnail, filePath);
            }*/
        ...
        public async Task<ResponseDTO> DeletePerson(Guid id)
        {
            ...
            //await _storageService.DeleteFile(person.Thumbnail.Replace("https://storage.googleapis.com/streaming-movie/", ""));
            if (await _context.SaveChangesAsync() > 0)
            {
